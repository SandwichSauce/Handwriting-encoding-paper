function train_test_package = divide_leave_one_char_out(trials_data)
    trial_target = trials_data.trial_target;
    trial_data = trials_data.trial_data;
    unique_char_num = trials_data.unique_char_num;
    ...
    if numel(target_repeat_num) == 1
        ...
        for unique_char_no = 1:unique_char_num
            tmp_char_trial_index = repeat_trial_index;
            tmp_char_trial_index(:,unique_char_no) = [];
            train_trial_index = sort(tmp_char_trial_index(:)');
            test_trial_index = sort(repeat_trial_index(:,unique_char_no))';
            train_data{1,unique_char_no}.train_trial_index = train_trial_index;
            test_data{1,unique_char_no}.test_trial_index = test_trial_index;
            if if_has_val
                tmp_val_target_from_1 = ceil(mod(unique_char_no+1,unique_char_num+0.1));
                val_trial_index = sort(repeat_trial_index(:,tmp_val_target_from_1))';
                val_data{1,unique_char_no}.val_trial_index = val_trial_index;
            end
            ...
            train_data{1,unique_char_no}.train_spike = train_spike;
            train_data{1,unique_char_no}.train_PVA = train_PVA;
            if if_has_inter_trial
                train_data{1,unique_char_no}.train_spike_inter_trial = train_spike_inter_trial;
                train_data{1,unique_char_no}.train_PVA_inter_trial = train_PVA_inter_trial;
                train_data{1,unique_char_no}.train_go_mask = train_go_mask;
            end
            train_data{1,unique_char_no}.train_stroke_PVA = train_stroke_PVA;
            train_data{1,unique_char_no}.train_stroke_spike = train_stroke_spike;
            train_data{1,unique_char_no}.train_break_PVA = train_break_PVA;
            train_data{1,unique_char_no}.train_break_spike = train_break_spike;
            train_data{1,unique_char_no}.train_state = train_state;
            
            train_data{1,unique_char_no}.train_absolute_position_spike_cell = train_absolute_position_spike_cell;
            train_data{1,unique_char_no}.train_absolute_position = train_absolute_position;
            train_data{1,unique_char_no}.train_position_offset_spike_cell = train_position_offset_spike_cell;
            train_data{1,unique_char_no}.train_position_offset = train_position_offset;
            train_data{1,unique_char_no}.train_position_offset_cumsumed_spike_cell = train_position_offset_cumsumed_spike_cell;
            train_data{1,unique_char_no}.train_position_offset_cumsumed_cell = train_position_offset_cumsumed_cell;
            train_data{1,unique_char_no}.train_position_offset_cumsumed = train_position_offset_cumsumed;
            train_data{1,unique_char_no}.train_stroke_spike_cell = train_stroke_spike_cell;
            train_data{1,unique_char_no}.train_stroke_cell = train_stroke_cell;
            train_data{1,unique_char_no}.train_state_unified_stroke_break = train_state_unified_stroke_break;
            train_data{1,unique_char_no}.train_state_separate_stroke_break = train_state_separate_stroke_break;
            
            if if_anaylse_stroke
                target_stroke_list = trials_data.params.unified_stroke_list;
                train_target_stroke_data = get_target_stroke_data(target_stroke_list,trial_data(train_trial_index));
                train_data{1,unique_char_no}.train_target_stroke_data = train_target_stroke_data;
            end
            ...
            test_data{1,unique_char_no}.test_spike = test_spike;
            test_data{1,unique_char_no}.test_PVA = test_PVA;
            if if_has_inter_trial
                test_data{1,unique_char_no}.test_spike_inter_trial = test_spike_inter_trial;
                test_data{1,unique_char_no}.test_PVA_inter_trial = test_PVA_inter_trial;
                test_data{1,unique_char_no}.test_go_mask = test_go_mask;
            end
            test_data{1,unique_char_no}.test_stroke_PVA = test_stroke_PVA;
            test_data{1,unique_char_no}.test_stroke_spike = test_stroke_spike;
            test_data{1,unique_char_no}.test_break_PVA = test_break_PVA;
            test_data{1,unique_char_no}.test_break_spike = test_break_spike;
            test_data{1,unique_char_no}.test_state = test_state;
            test_data{1,unique_char_no}.test_state_unified_stroke_break = test_state_unified_stroke_break;
            test_data{1,unique_char_no}.test_state_separate_stroke_break = test_state_separate_stroke_break;
            test_data{1,unique_char_no}.test_absolute_position_spike_cell = test_absolute_position_spike_cell;
            test_data{1,unique_char_no}.test_absolute_position = test_absolute_position;
            test_data{1,unique_char_no}.test_position_offset_spike_cell = test_position_offset_spike_cell;
            test_data{1,unique_char_no}.test_position_offset = test_position_offset;
            test_data{1,unique_char_no}.test_position_offset_cumsumed_spike_cell = test_position_offset_cumsumed_spike_cell;
            test_data{1,unique_char_no}.test_position_offset_cumsumed_cell = test_position_offset_cumsumed_cell;
            test_data{1,unique_char_no}.test_position_offset_cumsumed = test_position_offset_cumsumed;
            test_data{1,unique_char_no}.test_stroke_spike_cell = test_stroke_spike_cell;
            test_data{1,unique_char_no}.test_stroke_cell = test_stroke_cell;
            
            if if_anaylse_stroke
                target_stroke_list = trials_data.params.unified_stroke_list;
                test_target_stroke_data = get_target_stroke_data(target_stroke_list,trial_data(test_trial_index));
                test_data{1,unique_char_no}.test_target_stroke_data = test_target_stroke_data;
            end
            ...
            if if_has_val
                ...
                val_data{1,unique_char_no}.val_spike = val_spike;
                val_data{1,unique_char_no}.val_PVA = val_PVA;
                if if_has_inter_trial
                    val_data{1,unique_char_no}.val_spike_inter_trial = val_spike_inter_trial;
                    val_data{1,unique_char_no}.val_PVA_inter_trial = val_PVA_inter_trial;
                    val_data{1,unique_char_no}.val_go_mask = val_go_mask;
                end
                val_data{1,unique_char_no}.val_stroke_PVA = val_stroke_PVA;
                val_data{1,unique_char_no}.val_stroke_spike = val_stroke_spike;
                val_data{1,unique_char_no}.val_break_PVA = val_break_PVA;
                val_data{1,unique_char_no}.val_break_spike = val_break_spike;
                val_data{1,unique_char_no}.val_state = val_state;

                val_data{1,unique_char_no}.val_absolute_position_spike_cell = val_absolute_position_spike_cell;
                val_data{1,unique_char_no}.val_absolute_position = val_absolute_position;
                val_data{1,unique_char_no}.val_position_offset_spike_cell = val_position_offset_spike_cell;
                val_data{1,unique_char_no}.val_position_offset = val_position_offset;
                val_data{1,unique_char_no}.val_position_offset_cumsumed_spike_cell = val_position_offset_cumsumed_spike_cell;
                val_data{1,unique_char_no}.val_position_offset_cumsumed_cell = val_position_offset_cumsumed_cell;
                val_data{1,unique_char_no}.val_position_offset_cumsumed = val_position_offset_cumsumed;
                val_data{1,unique_char_no}.val_stroke_spike_cell = val_stroke_spike_cell;
                val_data{1,unique_char_no}.val_stroke_cell = val_stroke_cell;
                val_data{1,unique_char_no}.val_state_unified_stroke_break = val_state_unified_stroke_break;
                val_data{1,unique_char_no}.val_state_separate_stroke_break = val_state_separate_stroke_break;
                if if_anaylse_stroke
                    target_stroke_list = trials_data.params.unified_stroke_list;
                    val_target_stroke_data = get_target_stroke_data(target_stroke_list,trial_data(val_trial_index));
                    val_data{1,unique_char_no}.val_target_stroke_data = val_target_stroke_data;
                end
            end
        end
